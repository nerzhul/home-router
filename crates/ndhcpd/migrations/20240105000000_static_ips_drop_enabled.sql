-- Migrate static_ips: drop enabled column
...
INSERT INTO static_ips_new (ip_address, subnet_id, mac_address, hostname, created_at)
SELECT ip_address, subnet_id, mac_address, hostname, created_at FROM static_ips;
